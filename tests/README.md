...
`v2-interface.cjs` verifies the compact menus, selection-only reset, Ctrl+A, undo, continuous pages, targeted table creation, wrapping and on-demand page loading using synthetic PDFs.
